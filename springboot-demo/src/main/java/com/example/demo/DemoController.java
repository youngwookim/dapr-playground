...
public class DemoController {
  ...
  public Mono<String> pubMessage(@RequestBody String message) {
    return webClient.post().uri(URI.create("http://localhost:3500/v1.0/publish/kafka-pubsub/test"))
        .contentType(MediaType.APPLICATION_JSON).body(Mono.just(message), String.class).retrieve()
